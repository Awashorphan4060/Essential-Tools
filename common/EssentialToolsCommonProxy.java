package awashorphan4060.essentialtools.common;
...
public class EssentialToolsCommonProxy implements IGuiHandler{ //THIS IS IMPORTANT, CANNOT BE A PROXY/GUI HANDLER WITHOUT THIS!!
...
public void registerItems(){ //For registering Items
	//Sheathe
	LanguageRegistry.addName(EssentialTools.Sheathe, "Sheathe");
	GameRegistry.addRecipe(new ItemStack(EssentialTools.Sheathe), "LLL", " L ", "  L", Character.valueOf('L'), Item.leather);
}
}